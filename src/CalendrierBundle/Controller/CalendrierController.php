...
class CalendrierController extends Controller
{
    ...
    public function afficherProf2Action()
    {
        ...
        return $this->render('@Calendrier/Prof/afficher_prof2.html.twig', array("e" => $e));
    ...
    public function modifierProfAction()
    {
        ...
        return $this->render('@Calendrier/Prof/modifier_prof.html.twig', array("e" => $e));
    ...
    public function testAction($id)
    {
        ...
        if ($p != null) {
            ...
            return $this->render('@Calendrier/Calendrier/afficher_emploi2.html.twig', array("e" => $rep ,"p"=>$p));
        }

            return $this->render('@Calendrier/Calendrier/vide2.html.twig');
    ...
    {   $user=$this->getUser()->getClasse();
        $rep = $this->getDoctrine()->getRepository(Calendrier::class)->findByClasse($user);
        ...
        if ($usr != null) {
            ...
            return $this->render('@Calendrier/Calendrier/afficher_emploi_classe.html.twig', array("e" => $rep, "p" => $usr));
        }
        return $this->render('@Calendrier/Calendrier/vide3.html.twig', array("e" => $usr));
